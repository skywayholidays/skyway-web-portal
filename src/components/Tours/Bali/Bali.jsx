...
import PhotosTab from '../Thailand/PhotosTab';
import ItineraryTab from '../Thailand/ItineraryTab';
import InclusionsTab from '../Thailand/InclusionsTab';
    ...
    return (
        <div className="w-full flex flex-col md:flex-row justify-center max-w-7xl px-4 md:px-8">
            ...
            <div className="flex flex-col justify-center w-full md:w-2/3 py-6">
                {/* Heading */}
                <div className="mb-6">
                    <h1 className="text-2xl md:text-3xl font-bold text-center md:text-left">Best Of Bali</h1>
